...
3. Avoid clicking on unknown links in emails, WhatsApp, or Instagram DMs (common phishing trick).
4. Never share OTP, passwords, or personal details with anyone—even if they claim to be from a bank or government.
5. Keep your devices updated (software + antivirus) to prevent malware attacks.
6. Use only secure Wi-Fi networks; avoid logging into sensitive accounts on public Wi-Fi.
